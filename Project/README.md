...
*Note*: Some of the constraints can be ignored if program executes without check option `-c`.
* Hotels
...
* Customers
  ...
  * Each SSN has following format *'NNN-NN-NNNN'*, where *N* is a digit in range of *0-9*.
