...
def main():
    ...
    wolf_inn.add_menu_action(
        MenuAction('insert_serves', 'ADD A CUSTOMER INTERACTION', AppsParams.serves,
                   wolf_inn.client.insert))
    wolf_inn.add_menu_action(
        MenuAction('update_serves', 'UPDATE A CUSTOMER INTERACTION', AppsParams.serves,
                   wolf_inn.client.update))
    wolf_inn.add_menu_action(
        MenuAction('delete_serves', 'DELETE A CUSTOMER INTERACTION', AppsParams.serves,
                   wolf_inn.client.delete))
    wolf_inn.add_menu_action(
